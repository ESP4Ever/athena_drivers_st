...
enum {
  ...
  SENSOR_TYPE_PRIXIMITY_2 = 6,
  SENSOR_TYPE_PRIXIMITY_3 = 7,
...
typedef enum {
  ...
  SENSOR_TIMER_EVENT = 5,
  SENSOR_INTERRUPT_EVENT = 6,
  SENSOR_INIT_COMPLETE_EVENT = 7,
  SENSOR_ACTIVATE_COMPLETE_EVENT = 8,
  SENSOR_DEACTIVATE_COMPLETE_EVENT = 9,
